...
const Assumptions = ({ type }: AssumptionsProps) => (
  <div className="px-3">
    <div>
      ...
      <p>
        Interest rates and repyment thresholds for each plan type, we assume the
        same interest rate for the entirity of the loan:
      </p>
    </div>
    {/* here */}
    <GenerateAssumptions type={type} />
    <h3 className="block underline uppercase tracking-wide text-s font-bold mr-1">
      Salary
    </h3>
    <p>
      We assume the same salary for the entirity of the loan, soon there will be
      a feature to change this to a percentage yearly growth.
    </p>
  </div>
);
